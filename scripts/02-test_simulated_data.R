...
rules <- validator(
  ...
  PPEDUC %in% c("Less than high school", "High school degree/GED", "Some college/Associate",
                "Bachelor's degree", "Graduate/professional degree"),
  PPINCIMP %in% c("Less than $20,000", "$20,000 to $29,999", "$30,000 to $39,999",
  ...
  DISTRESS %in% c("Strongly disagree", "Disagree", "Neither agree nor disagree",
